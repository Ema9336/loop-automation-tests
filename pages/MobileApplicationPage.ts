...
export class MobileApplicationPage {
  ...
  constructor(private page: Page) {
    ...
    this.todoColumn = page.locator('h2:has-text("To Do")').locator('..');
  ...
  /**
   * Select the Mobile Application project from the sidebar
   */
  async selectProject() {
    await this.projectButtons.locator('h2:has-text("Mobile Application")').click();
  }
